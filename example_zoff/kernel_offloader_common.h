...
/*
 * No "function not implemented" return value because if a function
 * returns that value, the function is implemented. Also, zoff.c
 * should handle unimplemented functions.
 */
